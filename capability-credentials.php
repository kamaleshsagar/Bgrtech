			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="page-header-box">
						<h1 class="text-anime">Certifications & Credentials</h1>
					</div>
					<!-- Page Header Box End -->
				</div>
			</div>
					...
					<div class="gallery-container">
						<div class="tz-gallery">
							...
							<div class="row">
								...
								<div class="col-sm-6 col-md-3">
									<a class="lightbox" href="images/certificates/TVR13247-FACTORY-LICENSE.jpg">
										<img src="images/certificates/0343-PED-MUM_1.jpg" alt="Park">
									</a>
								</div>
								<div class="col-sm-6 col-md-3">
									<a class="lightbox" href="images/certificates/TVR13247-FACTORY-LICENSE.jpg">
										<img src="images/certificates/0343-PED-MUM_2.jpg" alt="Park">
									</a>
								</div>
