...
$query=mysqli_query($con,"Update  tblsports set CategoryName='$category',Description='$description' where id='$catid'");
if($query)
{
...
<html lang="en">
    <head>
        ...
        <title>Studio Dental | Dashboard | Add Category</title>
...
<?php 
$catid=intval($_GET['cid']);
$query=mysqli_query($con,"Select id,CategoryName,Description,PostingDate,UpdationDate from  tblsports where Is_Active=1 and id='$catid'");
$cnt=1;
