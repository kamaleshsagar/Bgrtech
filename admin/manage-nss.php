...
{
	$id=intval($_GET['rid']);
	$query=mysqli_query($con,"update tblnss set Is_Active='0' where id='$id'");
...
if($_GET['resid'])
{
	...
	$query=mysqli_query($con,"update tblnss set Is_Active='1' where id='$id'");
...
{
	$id=intval($_GET['rid']);
	$query=mysqli_query($con,"delete from  tblnss  where id='$id'");
...
<button id="addToTable" class="btn btn-success waves-effect waves-light">Add <i class="mdi mdi-plus-circle-outline" ></i></button>
												...
												<div class="table-responsive">
                                                    <table class="table m-0 table-colored-bordered table-bordered-primary">
                                                        ...
                                                        <tbody>
<?php 
$query=mysqli_query($con,"Select id,CategoryName,Description,PostingDate,UpdationDate from  tblnss where Is_Active=1");
$cnt=1;
...
<td><a href="edit_nss.php?cid=<?php echo htmlentities($row['id']);?>"><i class="fa fa-pencil" style="color: #29b6f6;"></i></a> 
...
<table class="table m-0 table-colored-bordered table-bordered-danger">
                                                        ...
                                                        <tbody>
<?php 
$query=mysqli_query($con,"Select id,CategoryName,Description,PostingDate,UpdationDate from  tblnss where Is_Active=0");
$cnt=1;
while($row=mysqli_fetch_array($query))
{
?>
