...
move_uploaded_file($_FILES["postimage"]["tmp_name"],"projects/".$imgnewfile);
...
// INSERT INTO `tblsubcategory`(`CategoryId`, `Subcategory`, `SubCatDescription`, `PostingDate`, `UpdationDate`, `Is_Active`) VALUES ('[value-1]','[value-2]','[value-3]','[value-4]','[value-5]','[value-6]','[value-7]')
    ...
    $query=mysqli_query($con,"insert into tbl_projects_list(CategoryId, Subcategory, SubCatDescription, PostingDate, UpdationDate, post_image, Is_Active) values('$title','$area','$description', now(), now(),'$imgnewfile', '$status')");
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Upload Projects</h4>
...
<?php } ?>
    ...
    <option value="Integrated-surface">Integrated Surface Facilities/Early Production Facilities</option>
    <option value="Gas-Gathering">Gas Gathering/Processing Station</option>
    <option value="Hydrogen-Generation">Hydrogen Generation,Purification & Storage</option>
    <option value="API-650-storage">API 650 Storage Tanks</option>
  </select>
	                                                </div>
	                                            </div>
	 <!--                                           <div class="form-group">-->
...
<br>
	                                            ...
	                                            <div class="form-group">
	                                                ...
	                                                <div class="col-md-10">
	                                                 <h4 class="m-b-30 m-t-0 header-title"><b>Product Image (format .jpeg /.jpg)</b></h4>
