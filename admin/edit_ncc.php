...
$query=mysqli_query($con,"Update  tblncc set CategoryName='$category',Description='$description' where id='$catid'");
if($query)
{
...
<?php 
$catid=intval($_GET['cid']);
$query=mysqli_query($con,"Select id,CategoryName,Description,PostingDate,UpdationDate from  tblncc where Is_Active=1 and id='$catid'");
$cnt=1;
