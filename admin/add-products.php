...
move_uploaded_file($_FILES["postimage"]["tmp_name"],"products/".$imgnewfile);
...
// INSERT INTO `tblsubcategory`(`CategoryId`, `Subcategory`, `SubCatDescription`, `PostingDate`, `UpdationDate`, `Is_Active`) VALUES ('[value-1]','[value-2]','[value-3]','[value-4]','[value-5]','[value-6]','[value-7]')
    $query=mysqli_query($con,"insert into tbl_products(CategoryId, Subcategory, SubCatDescription, PostingDate, UpdationDate, post_image, Is_Active) values('$title','$area','$description', now(), now(),'$imgnewfile', '$status')");
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Upload Products</h4>
...
<?php } ?>
    ...
    <option value="Oil-and-Gas-Product">Oil and Gas Product</option>
