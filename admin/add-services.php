...
move_uploaded_file($_FILES["postimage"]["tmp_name"],"services/".$imgnewfile);
...
// INSERT INTO `tblsubcategory`(`CategoryId`, `Subcategory`, `SubCatDescription`, `PostingDate`, `UpdationDate`, `Is_Active`) VALUES ('[value-1]','[value-2]','[value-3]','[value-4]','[value-5]','[value-6]','[value-7]')
    ...
    $query=mysqli_query($con,"insert into tbl_services_list(CategoryId, Subcategory, SubCatDescription, PostingDate, UpdationDate, post_image, Is_Active) values('$title','$area','$description', now(), now(),'$imgnewfile', '$status')");
