...
move_uploaded_file($_FILES["postimage"]["tmp_name"],"careers/".$imgnewfile);
...
// INSERT INTO `tblsubcategory`(`CategoryId`, `Subcategory`, `SubCatDescription`, `PostingDate`, `UpdationDate`, `Is_Active`) VALUES ('[value-1]','[value-2]','[value-3]','[value-4]','[value-5]','[value-6]','[value-7]')
    ...
    $query=mysqli_query($con,"insert into tbl_careers_list(CategoryId, Subcategory, SubCatDescription, PostingDate, UpdationDate, post_image, Is_Active) values('$title','$description2','$description', now(), now(),'$imgnewfile', '$status')");
                        ...
                        <div class="row">
							<div class="col-xs-12">
								<div class="page-title-box">
                                    <h4 class="page-title">Upload Content for Career</h4>
...
<?php } ?>
  ...
  <!--  <option value="Technical-Engineering-Services">Technical Engineering Services</option>-->
  <!--  <option value="Feasibility-Study">Feasibility Study</option>-->
  <!--  <option value="FEED-Engineering">FEED Engineering</option>-->
  <!--</select>-->
	 <!--                                               </div>-->
	 <!--                                           </div>-->
	 <!--                                           <div class="form-group">-->
...
<br>
	                                            ...
	                                            <div class="form-group">
	                                                <label class="col-md-2 control-label">Roles and Responsibilities</label>
	                                                <div class="col-md-10">
