...
<?php
$postid=intval($_GET['pid']);
$query=mysqli_query($con,"select * from tblposts where tblposts.id='$postid' and tblposts.Is_Active=1 ");
...
<textarea name="editor" id="editor"><?php echo htmlentities($row['PostDetails']);?></textarea>
</div>
