...
<head>
    ...
    <style>
        ...
        .page-header {
            background-image: url(images/GasProcessing_header.jpg);
            position: relative;
...
<body class="tt-magic-cursor">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="page-header-box">
                        <h1 class="text-anime">Gas Gathering/Processing Station</h1>
                    </div>
                    <!-- Page Header Box End -->
                </div>
            </div>
    ...
    <div class="our-projects">
        <div class="container">
            <?php $ret=mysqli_query($con,"SELECT * FROM tbl_projects_list WHERE `Subcategory` LIKE '%Gas-Gathering%' && Is_Active=1 ORDER BY SubCategoryId ASC");
							  $cnt=1;
...
<h2><a href="#"><?php echo $row['CategoryId']?></a></h2>
            ...
            <!--  <div class="row pb-50 div1 mb-20">
        ...
        <!-- <div class="col-lg-8 col-md-6"> -->
        <!-- Project Item Start -->
        <!-- <div class="project-item wow fadeInUp" data-wow-delay="0.75s" style="padding:20px;">

                        <h2><a href="#">Gas Dehydration Unit</a></h2>

                        <p>BGR Tech provides turnkey complete design, engineering, manufacturing, supply, installation
                            and commissioning of Modular Gas Dehydration Unit in Oil & Gas Industry to remove water from
                            natural gas so as to prevent hydrate formation, corrosion and pipeline blockages.
                            <br>
                            <br>
                            BGR Tech shall offer the Gas Dehydration Unit type based on Customer requirements /
                            specifications with optimized design to achieve the gas purity and the desired moisture
                            content.
                        </p>

                        <li>TEG based dehydration (with support of process Licensor)</li>
                        <li>Molecular Sieve Dehydration</li>
                        <br>
                        <p>As part of Gas Dehydration Unit, will include the following:</p>
                        <li>Contactors/Absorbers</li>
                        <li>Regeneration Unit</li>
                        <li>Water Removal</li>
        ...
        <!-- </div>
            ...
            <div class="row pb-50 div2 mb-20">
                <div class="col-lg-4 col-md-6 mb-20"> -->
        <!-- Project Item Start -->
        <!-- <div class="project-item wow fadeInUp" data-wow-delay="0.75s">
                        <div class="project-image">
        ...
        <!--  <div class="project-item wow fadeInUp" data-wow-delay="0.75s" style="padding:20px;">
                        ...
                        <h2><a href="#">Gas Sweetening Unit</a></h2>

                        <p>BGR Tech provides turnkey solution comprising design, engineering, fabrication, supply,
                            installation and commissioning of Gas Sweetening in Oil & Gas Industry to that removes acid
                            gases (primarily hydrogen sulfide (H₂S) and carbon dioxide (CO₂)) from natural gas so as to
                            improves the quality of the natural gas and makes it safer and more efficient for use in
                            industrial applications, power generation, and domestic consumption.
                            <br>
                            <br>
                            As BGR Tech, shall ensure that sweetened natural gas meets the specifications as prescribed
                            by Customer in compliance with the environmental regulations & local norms.
                        </p>

                        <p>
                            BGR Tech shall offer the Gas Sweetening Unit type based on Customer requirements /
                            specifications with optimized design to achieve the gas purity by reducing or eliminating
                            the acidic components (H2S & CO2).
                        </p>

                        <li>Amine Gas Sweetening (with support of process Licensor)</li>
                        <li> Sweetening Unit through Physical Absorption</li>
                        <br>
                        <p>As part of Gas Sweetening Unit, will include the following:</p>

                        <li>Contactor Tower (or) Absorber</li>
                        <li>Regeneration Unit</li>
                        <li>Sulfur Recovery Unit</li>
                        <li>Separation system</li>
                        <li>Control System</li>
