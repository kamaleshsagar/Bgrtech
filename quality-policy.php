...
.tz-gallery .lightbox:hover:before {
    opacity: 1;
        ...
        .page-header {
            ...
            position: relative;
            background-image: url(images/policy_header.jpg);
...
<body class="tt-magic-cursor">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="page-header-box">
                        <h1 class="text-anime">Quality Policy</h1>
                    </div>
                    <!-- Page Header Box End -->
                </div>
            </div>
    ...
    <div class="our-projects qualitypolicy">
        <div class="container">
            <div class="row div1 pb-50 mb-20">
                <div class="col-lg-12 col-md-12">
                    <!-- Project Item Start -->
                    <div class="project-item wow fadeInUp" data-wow-delay="0.1s" style="padding:20px;">

                        <div style="display: flex;padding: 10px;">
                            <img src="images/Quality-Objectives-icon.png" alt=""
                                style="width:100px;padding-right: 10px;">
                            <div>
                                <h2><a href="#">QUALITY OBJECTIVES</a></h2>
                                <p>The Corporate Quality Objectives are:</p>
                            </div>
                        </div>

                        <ul>
                            <li>To adopt and ensure continuous compliance of the International Quality Management System
                                -ISO 9001 2015. </li>
                            <li>To position as customer's preferred organisation, to provide end to end solution in
                                Green & Blue Hydrogen, Oil and Gas sector. </li>
                            <li>To provide highest quality of products and customer services through continual
                                improvement, innovation & ensuring compliance to statutory & regulatory requirements,
                                standards and codes.
                            </li>
                            <li>To develop suppliers committed to Quality at competitive cost and delivery.
                            </li>
                            <li>Enhance capability of human resources with focus on developing skills and competence to
                                achieve excellence.</li>
            ...
            <div class="row div2 pb-50 mb-20">
                <div class="col-lg-12 col-md-12">
                    <!-- Project Item Start -->
                    <div class="project-item wow fadeInUp" data-wow-delay="0.1s" style="padding:20px;">
                        <div style="display: flex;padding: 10px;">
                            <img src="images/Quality-Policy-Icon.png" alt="" style="width:100px;padding-right: 10px;">
                            <div>
                                <h2><a href="#">QUALITY POLICY</a></h2>
                                <p>We are committed to achieve Total Customer Satisfaction through:</p>
                            </div>
                        </div>

                        <ul>
                            <li>Providing high quality Products & Services, On-time delivery, complying to customer
                                requirements and all applicable requirements.</li>
                            <li>Continually reviewing and
                                improving Quality
                                Management Processes and Systems.</li>
                            <li>Building Quality Culture through team work, employee empowerment, supplier development
                                and ensuring safe and healthy work environment.</li>
