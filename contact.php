...
<div class="g-recaptcha" id="captcha" data-sitekey="6LeL7CIsAAAAAPq_ERyGMq0H6aQskE1H66dGzCdT">
    	
</div>
     <div class="help with-errors"></div>
      
									<div class="col-md-12 text-center custom-btn">
	...
	<script>
		$(function () {
			...
			$('form').on('submit', function (e) {
				...
				if (captcha.length == 0) {
        $("#captcha").next(".help").text("Please select captcha");
       is_error = true;
    }
