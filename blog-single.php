...
<body class="tt-magic-cursor">
	...
	<?php 
		...
		$ret1=mysqli_query($con,"SELECT * FROM `tblcontent` WHERE SubCategoryId='$postid'");
							  $cnt=1;
			...
			<<div class="row">
				<div class="col-md-12">
					...
					<div class="page-header-box">
						<h1 class="text-anime"><?php echo $row['CategoryId'];  ?></h1>
						<div class="post-single-meta wow fadeInUp" data-wow-delay="0.25s">
							<ul>
								<li><?php $dt= $row['UpdationDate'];
	...
	<div class="page-single-post" style="text-align: -webkit-center" ;>
		<div class="container">
			<div class="row">
			<div class="col-md-9">
				...
				<div class="post-content">
					<!-- Post Entry Start -->
					<p id="base64Input" style="display:none;"><?php echo $row['SubCatDescription'];  ?></p>
					<iframe class="post-entry" id="outputFrame"></iframe>
					<!-- Post Entry End -->
				...
				<div class="share-button sharer" style="display: block;">
					...
					<div class="social top center networks-5 ">
						<div class="shareit">
							...
							<a class="whatsapp" href="https://api.whatsapp.com/send?text=<?php echo $current_url?>"
								target="blank" title="whatsapp"><i class="fa-brands fa-whatsapp"></i></i></a>

							<!-- linkedin -->
							<a class="linkedin"
								href="https://www.linkedin.com/sharing/share-offsite/?url=<?php echo $current_url?>"
								target="blank" title="linkedin"><i class="fa-brands fa-linkedin"></i></a>

							<!-- twitter -->
							<a class="twitter" href="https://twitter.com/intent/tweet?url=<?php echo $current_url?>"
								target="blank" title="twitter"><img src="images/Twitter_25x25.png" alt
									style="height: 16px;"></a>
			...
			<div class="col-md-3" style="border-left: 2px solid #ece8e8;">
			    <div class="row" style="flex-direction:column;">
			        	<div class="section-title" style="margin-bottom:0px;">
						<h3 class="wow fadeInUp">Recent Articles</h3>
					</div>
			          <?php 
			          $g_id = $row['SubCategoryId'];
			          $ret=mysqli_query($con,"SELECT * FROM tblcontent WHERE Is_Active=1 && SubCategoryId != $g_id ORDER BY SubCategoryId DESC  LIMIT 5");
							  $cnt=1;
				...
				<!--<div class="col-lg-6">-->
					<!-- Blog Item Start -->
					<div class="blog-item wow fadeInUp" data-wow-delay="0.25s" style="margin:20px;">
						<div class="post-featured-image">
							<figure class="image-anime">
								<img src="<?php echo "admin/postimages/".$row2['image']?>" alt="">
							</figure>
						</div>

						<div class="post-item-body" style="border-radius:18px;padding:20px;">
							<h2 style="font-size:18px;"><a href="blog-single.php?cid=<?php echo $row2['SubCategoryId']?>"><?php echo $row['CategoryId']?></a></h2>
							<div class="post-meta">
								<ul>
									<li><i class="fa-regular fa-calendar-days"></i> <?php $dt= $row2['UpdationDate'];
                                echo date("d, M Y", strtotime($dt));
                                ?></li>
							...
							<div class="btn-readmore">
								<a href="blog-single.php?cid=<?php echo $row2['SubCategoryId']?>" class="btn-default">Read More</a>
							</div>
						</div>
					</div>
					<!-- Blog Item End -->
	...
	<script src="../../../assets/js/theme-panel.js"></script>
	  ...
	  <script>
            ...
            let decodedHTML = atob(base64String);
...
<!-- Mirrored from demo.awaikenthemes.com/html-preview/solor/html/blog-single.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 05 Oct 2024 11:17:16 GMT -->
