...
/* Override bootstrap column paddings */
		.our-process.gallery-container.tz-gallery .row>div {
			padding: 2px;
		}

		.our-process.gallery-container.tz-gallery .lightbox img {
			width: 100%;
			border-radius: 0;
			position: relative;
		}

		.our-process.gallery-container.tz-gallery .lightbox:before {
			position: absolute;
			top: 50%;
			left: 50%;
			margin-top: -13px;
		...
		.our-process.gallery-container.tz-gallery .lightbox:after {
			position: absolute;
			top: 0;
			left: 0;
			width: 100%;
...
.tz-gallery .lightbox:hover:before {
    opacity: 1;
		...
		.page-header {
			/*background-image: url(images/capabilities_header.jpg);*/
...
<body class="tt-magic-cursor">
								...
								<ul style="border-bottom-right-radius: 0px;">
									...
									<li class="nav-item"><a class="nav-link" href="#">Our Affiliate</a>
										<ul style="border-top-left-radius: 0px;">
											<li class="nav-item"><a class="nav-link"
													href="BGRTECH-Collabrah.php">BGRTECH Collabrah </a></li>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="page-header-box">
						<h1 class="text-anime">BGRTECH Collabrah</h1>
					</div>
					<!-- Page Header Box End -->
				</div>
			</div>
			...
			<div class="row">
				<div class="col-md-12">
					...
					<!--div class="section-title">
						<!--<h3 class="wow fadeInUp">ISO Certificates</h3>-->
					<!--h2 class="text-anime">ISO Certificates</h2>
					</div>
					<!-- Section Title End -->
						...
						<div class="tz-gallery">
							...
							<div class="row">
								...
								<div class="col-md-12 col-md-6">
									<!--<a class="lightbox" href="images/certificates/iso_1.jpeg">
										<img src="images/certificates/iso_1.jpeg" alt="Bridge">
									</a>-->
									<i class='fas fa-file-pdf fa-5x' style='color:red'></i>
									<a href="./BGRTECH-Collabrah_Brochure.pdf" target="_blank" target="_blank">BGRTECH
										Collabrah </a>

								</div>
								<!-- <div class="col-sm-6 col-md-4">
									<!--<a class="lightbox" href="images/certificates/iso_2.jpeg">
										<img src="images/certificates/iso_2.jpeg" alt="Park">
									</a>-->
								<!--  <i class='fas fa-file-pdf fa-5x' style='color:red'></i>
                                    <a href="Form_MGT_7_BGR Tech_2023-24.pdf"target="_blank">Form MGT 07_2023-24</a>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<!-- Section Title Start -->
	<!--		<div class="section-title">
						<!--<h3 class="wow fadeInUp">ASME Certificates</h3>-->
	<!--		<h2 class="text-anime">ASME Certificates</h2>
					</div>
					<!-- Section Title End -->
	<!--	<div class="gallery-container">
						<div class="tz-gallery">
							...
							<div class="row">
								...
								<div class="col-sm-6 col-md-4">
									<a class="lightbox" href="images/certificates/ASME-U,U2,S-Certificate-1.jpg">
										<img src="images/certificates/ASME-U,U2,S-Certificate-1.jpg" alt="Bridge">
									</a>
								</div>
								<div class="col-sm-6 col-md-4">
									<a class="lightbox" href="images/certificates/ASME-U,U2,S-Certificate-2.jpg">
										<img src="images/certificates/ASME-U,U2,S-Certificate-2.jpg" alt="Park">
									</a>
								</div>
								<div class="col-sm-6 col-md-4">
									<a class="lightbox" href="images/certificates/ASME-U,U2,S-Certificate-3.jpg">
										<img src="images/certificates/ASME-U,U2,S-Certificate-3.jpg" alt="Tunnel">
									</a>
								</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<!-- Section Title Start -->
	<!--		<div class="section-title">
						<!--<h3 class="wow fadeInUp">Statutory Certificates</h3>-->
	<!--			<h2 class="text-anime">Statutory Certificates</h2>
					</div>
					<!-- Section Title End -->
	<!--		<div class="gallery-container">
						<div class="tz-gallery">
							...
							<div class="row">
								...
								<div class="col-sm-6 col-md-3">
									<a class="lightbox" href="images/certificates/NB-R-Certificate.jpg">
										<img src="images/certificates/NB-R-Certificate.jpg" alt="Bridge">
									</a>
								</div>
								<div class="col-sm-6 col-md-3">
									<a class="lightbox" href="images/certificates/TVR13247-FACTORY-LICENSE.jpg">
										<img src="images/certificates/TVR13247-FACTORY-LICENSE.jpg" alt="Park">
									</a>
								</div>
								<div class="col-sm-6 col-md-3">
									<a class="lightbox" href="images/certificates/TVR13247-FACTORY-LICENSE.jpg">
	...
	<div class="modal fade lightbox-modal" id="lightbox-modal" tabindex="-1" style="background: #000;">
