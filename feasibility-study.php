...
<head>
    ...
    <style>
        ...
        .page-header {
            background-image: url(images/Feasibility-Study_header.jpg);
            position: relative;
...
<body class="tt-magic-cursor">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="page-header-box">
                        <h1 class="text-anime">Feasibility Study</h1>
                    </div>
                    <!-- Page Header Box End -->
                </div>
            </div>
    ...
    <div class="our-projects">
        <div class="container">
             <?php $ret=mysqli_query($con,"SELECT * FROM tbl_services_list WHERE `Subcategory` LIKE '%Feasibility-Study%' && Is_Active=1 ORDER BY SubCategoryId DESC");
							  $cnt=1;
                            ...
                            <div class="col-lg-4 col-md-4">
                                ...
                                <div class="footer-links">
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="gas-dehydration-unit.php">Gas
                                                Dehydration Unit</a></li>
                                        <li><a href="gas-sweetening-unit.php">Gas
