...
<head>
    ...
    <style>
        ...
        .page-header {
            background-image: url(images/feed_header.jpg);
            position: relative;
...
<body class="tt-magic-cursor">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="page-header-box">
                        <h1 class="text-anime">Front End Engineering Design (FEED) Services</h1>
                    </div>
                    <!-- Page Header Box End -->
                </div>
            </div>
    ...
    <div class="our-projects">
        <div class="container">
             ...
             <?php $ret=mysqli_query($con,"SELECT * FROM tbl_services_list WHERE `Subcategory` LIKE '%FEED-Engineering%' && Is_Active=1 ORDER BY SubCategoryId DESC");
							  $cnt=1;
