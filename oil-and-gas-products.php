...
<head>
	...
	<style>
		...
		.page-header {
			background-image: url(images/Oil&Gas_Header.jpg);
			position: relative;
...
<body class="tt-magic-cursor">
			...
			<div class="row">
				<div class="col-md-12">
					...
					<div class="page-header-box">
						<h1 class="text-anime">Oil & Gas Products</h1>
					</div>
					<!-- Page Header Box End -->
				</div>
			</div>
	...
	<div class="our-projects">
		<div class="container">
		  <?php 
$ret=mysqli_query($con,"SELECT * FROM tbl_products WHERE `Subcategory` LIKE '%Oil-and-Gas-Product%' && Is_Active=1 ORDER BY SubCategoryId ASC");
$cnt=1;
while($row=mysqli_fetch_array($ret)) {  
    $rowClass = ($cnt % 2 == 0) ? 'div2' : 'div1'; 
?>
    <div class="row pb-50 <?php echo $rowClass; ?> mb-20 project-row">
        <div class="col-lg-4 col-md-6 mb-20 image-container">
            <!-- Project Item Start -->
            <div class="project-item wow fadeInUp" data-wow-delay="0.75s">
                <div class="project-image">
                    <figure>
                        <img src="<?php echo "admin/products/".$row['post_image']; ?>" alt="">
                    </figure>
                </div>
            </div>
            <!-- Project Item End -->
        ...
        <div class="col-lg-8 col-md-6 ">
            <!-- Project Item Start -->
            <div class="text">
                <div class="project-item wow fadeInUp text-content1 text-container" data-wow-delay="0.75s"  id="textContent1"
                    style="padding:20px;">
                    <h2><a href="#"><?php echo $row['CategoryId']?></a></h2>
                    <p><?php echo $row['SubCatDescription']?></p>
                </div>
                <button class="toggle-btn1 btn-default" id="toggleBtn1" style="display:none;">Read more</button>
            </div>
            <!-- Project Item End -->
        </div>
    </div>  
