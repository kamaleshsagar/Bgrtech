...
<head>
    ...
    <style>
        ...
        .page-header {
            background-image: url(images/IntegratedSurface_header.jpg);
            position: relative;
...
<body class="tt-magic-cursor">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="page-header-box">
                        <h1 class="text-anime">Integrated Surface Facilities/Early Production Facilities</h1>
                    </div>
                    <!-- Page Header Box End -->
                </div>
            </div>
    ...
    <div class="our-projects">
        <div class="container">
            <?php $ret=mysqli_query($con,"SELECT * FROM tbl_projects_list WHERE `Subcategory` LIKE '%Integrated-surface%' && Is_Active=1 ORDER BY SubCategoryId ASC");
							  $cnt=1;
