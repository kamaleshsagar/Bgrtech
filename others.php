...
<body class="tt-magic-cursor">
    ...
    <div class="our-projects">
        <div class="container">
            <?php $ret=mysqli_query($con,"SELECT * FROM tbl_products WHERE `Subcategory` LIKE '%Others%' && Is_Active=1 ORDER BY SubCategoryId ASC");
							  $cnt=1;
							  while($row=mysqli_fetch_array($ret))
							  {  $rowClass = ($cnt % 2 == 0) ? 'div2' : 'div1'; ?>
							  
            <div class="row <?php echo $rowClass; ?> pb-50 mb-20">
                ...
                <div class="col-lg-8 col-md-6">
                    <!-- Project Item Start -->
                    <div class="project-item wow fadeInUp text-content1 text-container" data-wow-delay="0.75s" style="padding:20px;" id="textContent1">
                            ...
                            <div class="col-lg-4 col-md-4">
                                ...
                                <div class="footer-links">
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="hydrogen-generation-purification-storage.php">Hydrogen
                                                Generation,
                                                Purification
                                                & Storage</a></li>
